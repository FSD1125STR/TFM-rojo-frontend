...
export function MatchInfoCard({ match }) {
  ...
  return (
    <div test-id="el-a2b3c4d5" className="flex flex-col gap-4">
        ...
        <div className="p-5 flex flex-col gap-5">
          ...
          <div className="grid grid-cols-2 gap-x-6 gap-y-4">
            <div className="flex flex-col gap-0.5">
              ...
              <span className="text-sm font-semibold text-base-content">{formatMatchDate(match.dateTime)}</span>
            </div>
            <div className="flex flex-col gap-0.5">
              <span className="flex items-center gap-1.5 text-[10px] font-bold text-base-content/50 uppercase tracking-wider">
                <span className="material-symbols-outlined text-[12px]">schedule</span> Hora
              </span>
              <span className="text-sm font-semibold text-base-content">{formatMatchTime(match.dateTime)}</span>
            </div>
