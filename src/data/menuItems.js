export const menuItems = [
  ...
  { label: 'Partidos', to: '/partidos', icon: 'sports_soccer', permission: 'matches.view', end: true },
  { label: 'Calendario', to: '/partidos/calendario', icon: 'calendar_month', permission: 'matches.view' },
