...
import { BadgeGeneric } from '../BadgeGeneric/BadgeGeneric'
...
export const ConBadges = {
  ...
  parameters: {
    docs: {
      description: {
        story: `**Ejemplo con BadgeGeneric en columnas**
...
\`\`\`jsx
{
  ...
  label: 'Estado',
  render: (value) => (
    <BadgeGeneric variant="success" icon="check_circle" size="sm" pill>
      {value}
    </BadgeGeneric>
  )
}
